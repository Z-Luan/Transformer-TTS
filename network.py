...
class MelDecoder(nn.Module):
    ...
    def forward(self, memory, decoder_input, c_mask, pos):
        # memory: encoder的输出 [bsz,max_text_len,num_hidden]
        # decoder_input: decoder的输入 [bsz,max_T,num_mels]
        # c_mask: encoder输出对应的mask [bsz,max_text_len] 对应memory
        # pos: [bsz,max_T] 对应decoder_input
